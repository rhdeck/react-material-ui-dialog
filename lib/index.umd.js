(function (global, factory) {
  ...
  var DialogProvider = function DialogProvider(_ref) {
    ...
    return [React__default.createElement(core.Dialog, {
      ...
      return React__default.createElement(core.ListItem, {
        ...
        enabled: !hidden,
        invisible: true
      }, keyMap & React__default.createElement(core.ListItemAvatar, null, React__default.createElement(Avatar, null, keyMap)), icon & React__default.createElement(core.ListItemAvatar, null, React__default.createElement(Avatar, null, icon)), React__default.createElement(core.ListItemText, {
        primary: title,
        secondary: description
      })));
    })), !!dialogActions.length && React__default.createElement(core.DialogActions, null, dialogActions.map(function (_ref3) {
      var key = _ref3.key,
          title = _ref3.title;
  ...
  var useShowDialog = function useShowDialog() {
    ...
    var showDialog = React.useCallback(function _callee(_ref4) {
      var title,
          _ref4$cancelText,
          cancelText,
          _ref4$actions,
