(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@material-ui/core'), require('react-material-ui-keyboard-badge')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@material-ui/core', 'react-material-ui-keyboard-badge'], factory) :
  (global = global || self, factory(global.reactSampleComponentsLibrary = {}, global.React, global.core, global.reactMaterialUiKeyboardBadge));
}(this, (function (exports, React, core, reactMaterialUiKeyboardBadge) { 'use strict';
  ...
  var DialogProvider = function DialogProvider(_ref) {
    ...
    return [React__default.createElement(core.Dialog, {
      ...
      return React__default.createElement(core.ListItem, {
        ...
        return [badgeContent && React__default.createElement(core.ListItemAvatar, {
          key: "badgeContent"
        }, React__default.createElement(core.Avatar, {
          color: "primary"
        }, badgeContent)), icon && React__default.createElement(core.ListItemAvatar, {
          key: "icon"
        }, React__default.createElement(core.Avatar, null, icon)), React__default.createElement(core.ListItemText, {
          key: "text",
          primary: title,
          secondary: description
        })];
      }));
    })), !!dialogActions.length && React__default.createElement(core.DialogActions, null, dialogActions.map(function (_ref4) {
      var key = _ref4.key,
          title = _ref4.title,
          color = _ref4.color,
          variant = _ref4.variant;
      return React__default.createElement(core.Button, _extends({
  ...
  var useShowDialog = function useShowDialog() {
    ...
    var showDialog = React.useCallback(function _callee(_ref5) {
      var title,
          _ref5$cancelText,
          cancelText,
          _ref5$actions,
