...
import { Dialog, DialogTitle, DialogContent, ListItem, ListItemAvatar, Avatar, ListItemText, DialogActions, Button, Grid, CircularProgress } from '@material-ui/core';
import { useKeyboardScopes, KeyboardBadge } from 'react-material-ui-keyboard-badge';
...
var DialogProvider = function DialogProvider(_ref) {
  ...
  var _useState15 = useState("cancel"),
  ...
  var clearDismiss = useCallback(function () {
  ...
  var dismissDialog = useCallback(function (key) {
    if (key === CUSTOM) setDismissKey(state);else setDismissKey(key);
    setIsDialog(false);
  }, [state]);

  var _useState25 = useState(true),
      _useState26 = _slicedToArray(_useState25, 2),
      isDismissable = _useState26[0],
      setIsDismissable = _useState26[1];
  ...
  var _useState27 = useState(false),
      ...
      disabledSimple = _useState28[0],
      setDisabledSimple = _useState28[1];
  ...
  }, [cancelText, dismissKey, clearDismiss, isDialog, setMessage, setTitle, setActions, setCancelText, setIsDialog, setPre, setPost, setContentStyle, setScrollViewStyle, setIsDismissable, isDismissable, setDismissKey, setDialogActions, setState, state]);
  var Message = message;
  return [React.createElement(Dialog, {
  ...
  }, title && React.createElement(DialogTitle, null, title), React.createElement(DialogContent, {
    style: contentStyle
  }, pre, !message ? null : typeof message === "String" ? React.createElement(DialogContentText, null, message) : typeof message === "function" ? React.createElement(Message, {
    ...
    return React.createElement(ListItem, {
    ...
    }, React.createElement(KeyboardBadge, {
      ...
      var badgeContent = _ref3.badgeContent;
      return [badgeContent && React.createElement(ListItemAvatar, {
        key: "badgeContent"
      }, React.createElement(Avatar, {
        color: "primary"
      }, badgeContent)), icon && React.createElement(ListItemAvatar, {
        key: "icon"
      }, React.createElement(Avatar, null, icon)), React.createElement(ListItemText, {
        key: "text",
        primary: title,
        secondary: description
      })];
    }));
  })), !!dialogActions.length && React.createElement(DialogActions, null, dialogActions.map(function (_ref4) {
    var key = _ref4.key,
        title = _ref4.title,
        color = _ref4.color,
...
var withDialog = function withDialog(C) {
  return function (props) {
    return React.createElement(DialogProvider, null, React.createElement(C, props));
  };
};
...
var useAbortDialog = function useAbortDialog() {
  ...
  var abortDialog = useCallback(function () {
...
var useShowDialog = function useShowDialog() {
  ...
  var showDialog = useCallback(function _callee(_ref5) {
    var title,
        _ref5$cancelText,
        cancelText,
        _ref5$actions,
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            title = _ref5.title, _ref5$cancelText = _ref5.cancelText, cancelText = _ref5$cancelText === void 0 ? "Close" : _ref5$cancelText, _ref5$actions = _ref5.actions, actions = _ref5$actions === void 0 ? [] : _ref5$actions, _ref5$message = _ref5.message, message = _ref5$message === void 0 ? null : _ref5$message, _ref5$pre = _ref5.pre, pre = _ref5$pre === void 0 ? null : _ref5$pre, _ref5$post = _ref5.post, post = _ref5$post === void 0 ? null : _ref5$post, _ref5$contentStyle = _ref5.contentStyle, contentStyle = _ref5$contentStyle === void 0 ? {} : _ref5$contentStyle, _ref5$scrollViewStyle = _ref5.scrollViewStyle, scrollViewStyle = _ref5$scrollViewStyle === void 0 ? {
              maxHeight: 300
            } : _ref5$scrollViewStyle, _ref5$isDismissable = _ref5.isDismissable, isDismissable = _ref5$isDismissable === void 0 ? true : _ref5$isDismissable, _ref5$dialogActions = _ref5.dialogActions, dialogActions = _ref5$dialogActions === void 0 ? [] : _ref5$dialogActions, state = _ref5.state;
  ...
  var _useState31 = useState(null),
      ...
      promise = _useState32[0],
      setPromise = _useState32[1];
...
var useSpinner = function useSpinner() {
  ...
  var _useState33 = useState(false),
      ...
      isShowing = _useState34[0],
      setIsShowing = _useState34[1];
  ...
  var spinnerFunc = useCallback(function () {
    setIsShowing(true);
...
var useAreYouSure = function useAreYouSure() {
  var showDialog = useShowDialog();
  return useCallback(function _callee2() {
    var _ref6,
        _ref6$yesText,
        yesText,
        _ref6$noText,
    ...
    return regeneratorRuntime.async(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _ref6 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref6$yesText = _ref6.yesText, yesText = _ref6$yesText === void 0 ? "Yes" : _ref6$yesText, _ref6$noText = _ref6.noText, noText = _ref6$noText === void 0 ? "No" : _ref6$noText, props = _objectWithoutProperties(_ref6, ["yesText", "noText"]);
            _context2.next = 3;
...
export { CUSTOM, DialogProvider, REJECT, useAbortDialog, useAreYouSure, useShowDialog, useSpinner, withDialog };
