...
import { Dialog, DialogTitle, DialogContent, ListItem, ListItemAvatar, ListItemText, DialogActions, Button, Grid, CircularProgress } from '@material-ui/core';
...
var DialogProvider = function DialogProvider(_ref) {
  ...
  return [React.createElement(Dialog, {
    ...
    return React.createElement(ListItem, {
      ...
      enabled: !hidden,
      invisible: true
    }, keyMap & React.createElement(ListItemAvatar, null, React.createElement(Avatar, null, keyMap)), icon & React.createElement(ListItemAvatar, null, React.createElement(Avatar, null, icon)), React.createElement(ListItemText, {
      primary: title,
      secondary: description
    })));
  })), !!dialogActions.length && React.createElement(DialogActions, null, dialogActions.map(function (_ref3) {
    var key = _ref3.key,
        title = _ref3.title;
...
var useShowDialog = function useShowDialog() {
  ...
  var showDialog = useCallback(function _callee(_ref4) {
    var title,
        _ref4$cancelText,
        cancelText,
        _ref4$actions,
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            title = _ref4.title, _ref4$cancelText = _ref4.cancelText, cancelText = _ref4$cancelText === void 0 ? "Close" : _ref4$cancelText, _ref4$actions = _ref4.actions, actions = _ref4$actions === void 0 ? [] : _ref4$actions, _ref4$message = _ref4.message, message = _ref4$message === void 0 ? null : _ref4$message, _ref4$pre = _ref4.pre, pre = _ref4$pre === void 0 ? null : _ref4$pre, _ref4$post = _ref4.post, post = _ref4$post === void 0 ? null : _ref4$post, _ref4$contentStyle = _ref4.contentStyle, contentStyle = _ref4$contentStyle === void 0 ? {} : _ref4$contentStyle, _ref4$scrollViewStyle = _ref4.scrollViewStyle, scrollViewStyle = _ref4$scrollViewStyle === void 0 ? {
              maxHeight: 300
            } : _ref4$scrollViewStyle, _ref4$isDismissable = _ref4.isDismissable, isDismissable = _ref4$isDismissable === void 0 ? true : _ref4$isDismissable, _ref4$dialogActions = _ref4.dialogActions, dialogActions = _ref4$dialogActions === void 0 ? [] : _ref4$dialogActions;
    ...
    return regeneratorRuntime.async(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _ref5 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref5$yesText = _ref5.yesText, yesText = _ref5$yesText === void 0 ? "Yes I am sure" : _ref5$yesText, _ref5$noText = _ref5.noText, noText = _ref5$noText === void 0 ? "Never mind" : _ref5$noText, props = _objectWithoutProperties(_ref5, ["yesText", "noText"]);
            _context2.next = 3;
...
export { DialogProvider, useAbortDialog, useAreYouSure, useShowDialog, useSpinner, withDialog };
