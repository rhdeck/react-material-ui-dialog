...
import { Dialog, DialogTitle, DialogContent, ListItem, ListItemAvatar, ListItemText, DialogActions, Grid, CircularProgress } from '@material-ui/core';
...
var DialogProvider = function DialogProvider(_ref) {
  ...
  var _useState13 = useState("cancel"),
      _useState14 = _slicedToArray(_useState13, 2),
      cancelText = _useState14[0],
      setCancelText = _useState14[1];

  var _useState15 = useState(),
      _useState16 = _slicedToArray(_useState15, 2),
      dismissKey = _useState16[0],
      setDismissKey = _useState16[1];

  var _useState17 = useState({}),
      _useState18 = _slicedToArray(_useState17, 2),
      contentStyle = _useState18[0],
      setContentStyle = _useState18[1];

  var _useState19 = useState({
    maxHeight: 300
  }),
      _useState20 = _slicedToArray(_useState19, 2),
      scrollViewStyle = _useState20[0],
      setScrollViewStyle = _useState20[1];
  ...
  var _useState21 = useState(true),
      ...
      isDismissable = _useState22[0],
      setIsDismissable = _useState22[1];
  ...
  }, [cancelText, dismissKey, clearDismiss, isDialog, setMessage, setTitle, setActions, setCancelText, setIsDialog, setPre, setPost, setContentStyle, setScrollViewStyle, setIsDismissable, isDismissable, setDismissKey]);
  var Message = message;
  return [React.createElement(Dialog, {
  ...
  }, title && React.createElement(DialogTitle, null, title), React.createElement(DialogContent, null, pre, !message ? null : typeof message === "String" ? React.createElement(DialogContentText, null, message) : typeof message === "function" ? React.createElement(Message, {
    ...
    return React.createElement(ListItem, {
      ...
      action: action,
      enabled: !hidden
    }, icon && React.createElement(ListItemAvatar, null, React.createElement(Avatar, null, icon)), React.createElement(ListItemText, {
      primary: title,
      secondary: description
    })));
  })), React.createElement(DialogActions, null)), React.createElement(Provider, {
    key: "provider",
    value: value
  }, children)];
};
...
var useShowDialog = function useShowDialog() {
  ...
  var showDialog = useCallback(function _callee(_ref3) {
    var title,
        _ref3$cancelText,
        cancelText,
        _ref3$actions,
        ...
        switch (_context.prev = _context.next) {
          case 0:
            title = _ref3.title, _ref3$cancelText = _ref3.cancelText, cancelText = _ref3$cancelText === void 0 ? "Close" : _ref3$cancelText, _ref3$actions = _ref3.actions, actions = _ref3$actions === void 0 ? [] : _ref3$actions, _ref3$message = _ref3.message, message = _ref3$message === void 0 ? null : _ref3$message, _ref3$pre = _ref3.pre, pre = _ref3$pre === void 0 ? null : _ref3$pre, _ref3$post = _ref3.post, post = _ref3$post === void 0 ? null : _ref3$post, _ref3$contentStyle = _ref3.contentStyle, contentStyle = _ref3$contentStyle === void 0 ? {} : _ref3$contentStyle, _ref3$scrollViewStyle = _ref3.scrollViewStyle, scrollViewStyle = _ref3$scrollViewStyle === void 0 ? {
              maxHeight: 300
            } : _ref3$scrollViewStyle, _ref3$isDismissable = _ref3.isDismissable, isDismissable = _ref3$isDismissable === void 0 ? true : _ref3$isDismissable;
  ...
  }, [setTitle, setCancelText, setActions, setMessage, setPre, setPost, setContentStyle, setScrollViewStyle, setPromise, setContentStyle, setIsDismissable]);

  var _useState25 = useState(null),
      _useState26 = _slicedToArray(_useState25, 2),
      promise = _useState26[0],
      setPromise = _useState26[1];

  useEffect(function () {
    console.log("Hit useeffect with dismissKey (maybe promise changed too) ", dismissKey, promise);
    if (!promise) return;
...
var useSpinner = function useSpinner() {
  ...
  var _useState27 = useState(false),
      ...
      isShowing = _useState28[0],
      setIsShowing = _useState28[1];
